...
```bash
DATABASE_URL="postgresql://postgres.<PROJECT_REF>:[PASSWORD]@<POOLER_HOST>:5432/postgres?sslmode=require&uselibpqcompat=true"
```
...
```bash
DATABASE_URL="postgresql://postgres.<PROJECT_REF>:[PASSWORD]@<POOLER_HOST>:6543/postgres?sslmode=require&uselibpqcompat=true"
```
